...
// Misc mission tools not belonging to an entity area
// (mission music, editor view).
extern const McpToolDef mcp_mission_misc_tool_defs[];
extern const size_t mcp_mission_misc_tool_def_count;
