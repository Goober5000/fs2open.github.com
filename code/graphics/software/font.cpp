...
void gr_printf(int x, int y, const char * format, SCP_FORMAT_STRING ... )  SCP_FORMAT_STRING_ARGS(3, 4)
{
	va_list args;
...
void gr_printf(int x, int y, size_t len, const char * format, SCP_FORMAT_STRING ... )  SCP_FORMAT_STRING_ARGS(3, 4)
{
	va_list args;
	...
	va_start(args, format);
	vsnprintf(grx_printf_text, len, format, args);
	va_end(args);
...
void gr_printf_menu(int x, int y, const char * format, SCP_FORMAT_STRING ... )  SCP_FORMAT_STRING_ARGS(3, 4)
{
	va_list args;
...
void gr_printf_menu(int x, int y, size_t len, const char * format, SCP_FORMAT_STRING ... )  SCP_FORMAT_STRING_ARGS(3, 4)
{
	va_list args;
...
void gr_printf_menu_zoomed(int x, int y, const char * format, SCP_FORMAT_STRING ... )  SCP_FORMAT_STRING_ARGS(3, 4)
{
	va_list args;
...
void gr_printf_menu_zoomed(int x, int y, size_t len, const char * format, SCP_FORMAT_STRING ... )  SCP_FORMAT_STRING_ARGS(3, 4)
{
	va_list args;
...
void gr_printf_no_resize(int x, int y, const char * format, SCP_FORMAT_STRING ... )  SCP_FORMAT_STRING_ARGS(3, 4)
{
	va_list args;
...
void gr_printf_no_resize(int x, int y, size_t len, const char * format, SCP_FORMAT_STRING ... )  SCP_FORMAT_STRING_ARGS(3, 4)
{
	va_list args;
