 ...
 * @param keep_reference        If true, the caller's load-count reference is kept rather than given up, and the data is
 *                              only freed if the caller is the sole holder; see bm_page_out()
 *
